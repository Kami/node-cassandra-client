...
var Cassandra_get_counter_args = function(args){
  this.key = null
  this.path = null
  this.consistency_level = 1
if( args != null ){  if (null != args.key)
...
Cassandra_get_counter_args.prototype = {}
Cassandra_get_counter_args.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
...
Cassandra_get_counter_args.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_get_counter_args')
  if (null != this.key) {
    output.writeFieldBegin('key', Thrift.Type.STRING, 1)
    output.writeString(this.key)
    output.writeFieldEnd()
...
var Cassandra_get_counter_result = function(args){
  this.success = null
  this.ire = null
  this.nfe = null
  this.ue = null
...
Cassandra_get_counter_result.prototype = {}
Cassandra_get_counter_result.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
...
Cassandra_get_counter_result.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_get_counter_result')
  if (null != this.success) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0)
    this.success.write(output)
    output.writeFieldEnd()
...
var Cassandra_get_counter_slice_args = function(args){
  this.key = null
  this.column_parent = null
  this.predicate = null
  this.consistency_level = 1
...
Cassandra_get_counter_slice_args.prototype = {}
Cassandra_get_counter_slice_args.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
...
Cassandra_get_counter_slice_args.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_get_counter_slice_args')
  if (null != this.key) {
    output.writeFieldBegin('key', Thrift.Type.STRING, 1)
    output.writeString(this.key)
    output.writeFieldEnd()
...
var Cassandra_get_counter_slice_result = function(args){
  this.success = null
  this.ire = null
  this.ue = null
  this.te = null
...
Cassandra_get_counter_slice_result.prototype = {}
Cassandra_get_counter_slice_result.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
...
Cassandra_get_counter_slice_result.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_get_counter_slice_result')
  if (null != this.success) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0)
    {
      output.writeListBegin(Thrift.Type.STRUCT, this.success.length)
...
var Cassandra_multiget_counter_slice_args = function(args){
  this.keys = null
  this.column_parent = null
  this.predicate = null
  this.consistency_level = 1
...
Cassandra_multiget_counter_slice_args.prototype = {}
Cassandra_multiget_counter_slice_args.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
...
Cassandra_multiget_counter_slice_args.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_multiget_counter_slice_args')
  if (null != this.keys) {
    output.writeFieldBegin('keys', Thrift.Type.LIST, 1)
    {
      output.writeListBegin(Thrift.Type.STRING, this.keys.length)
      {
        for(var iter186 in this.keys)
        {
          if (this.keys.hasOwnProperty(iter186))
          {
            iter186=this.keys[iter186]
...
var Cassandra_multiget_counter_slice_result = function(args){
  this.success = null
  this.ire = null
  this.ue = null
  this.te = null
...
Cassandra_multiget_counter_slice_result.prototype = {}
Cassandra_multiget_counter_slice_result.prototype.read = function(input){ 
  var ret = input.readStructBegin()
  while (1) 
  {
    var ret = input.readFieldBegin()
      ...
      case 0:      if (ftype == Thrift.Type.MAP) {
        {
          ...
          var _vtype189 = 0
          rtmp3 = input.readMapBegin()
          _ktype188= rtmp3.ktype
          _vtype189= rtmp3.vtype
          _size187= rtmp3.size
          for (var _i191 = 0; _i191 < _size187; ++_i191)
          {
            key192 = null
            val193 = null
            key192 = input.readString()
            {
              var _size194 = 0
              var rtmp3
              val193 = []
...
Cassandra_multiget_counter_slice_result.prototype.write = function(output){ 
  output.writeStructBegin('Cassandra_multiget_counter_slice_result')
  if (null != this.success) {
    output.writeFieldBegin('success', Thrift.Type.MAP, 0)
    {
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.LIST, Thrift.objectLength(this.success))
      {
        for(var kiter200 in this.success)        {
          if (this.success.hasOwnProperty(kiter200))
          {
            ...
            {
              output.writeListBegin(Thrift.Type.STRUCT, viter201.length)
              {
                for(var iter202 in viter201)
                {
                  if (viter201.hasOwnProperty(iter202))
                  {
                    iter202=viter201[iter202]
      ...
      case 0:      if (ftype == Thrift.Type.MAP) {
        {
          ...
          var _vtype205 = 0
          rtmp3 = input.readMapBegin()
          _ktype204= rtmp3.ktype
          _vtype205= rtmp3.vtype
          _size203= rtmp3.size
          for (var _i207 = 0; _i207 < _size203; ++_i207)
          {
            ...
            key208 = input.readString()
            {
              ...
              var _etype213 = 0
              rtmp3 = input.readListBegin()
              _etype213 = rtmp3.etype
              _size210 = rtmp3.size
              for (var _i214 = 0; _i214 < _size210; ++_i214)
              {
                var elem215 = null
      ...
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.LIST, Thrift.objectLength(this.success))
      {
        for(var kiter216 in this.success)        {
          if (this.success.hasOwnProperty(kiter216))
          {
            ...
            {
              output.writeListBegin(Thrift.Type.STRING, viter217.length)
              {
      ...
      case 0:      if (ftype == Thrift.Type.LIST) {
        {
          ...
          var _etype229 = 0
          rtmp3 = input.readListBegin()
          _etype229 = rtmp3.etype
          _size226 = rtmp3.size
          for (var _i230 = 0; _i230 < _size226; ++_i230)
          {
            var elem231 = null
            elem231 = new ttypes.TokenRange()
            elem231.read(input)
            this.success.push(elem231)
          }
          input.readListEnd()
        }
      } else {
...
Cassandra_describe_ring_result.prototype.write = function(output){ 
  ...
  if (null != this.success) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0)
    {
      output.writeListBegin(Thrift.Type.STRUCT, this.success.length)
      {
        for(var iter232 in this.success)
        {
          if (this.success.hasOwnProperty(iter232))
          {
            iter232=this.success[iter232]
      ...
      case 0:      if (ftype == Thrift.Type.LIST) {
        {
          ...
          var _etype236 = 0
          rtmp3 = input.readListBegin()
          _etype236 = rtmp3.etype
          _size233 = rtmp3.size
          for (var _i237 = 0; _i237 < _size233; ++_i237)
          {
            var elem238 = null
...
CassandraClient.prototype.get_counter = function(key,path,consistency_level,callback){
  this.seqid += 1;
  this._reqs[this.seqid] = callback;
    this.send_get_counter(key, path, consistency_level)
}

CassandraClient.prototype.send_get_counter = function(key,path,consistency_level){
  var output = new this.pClass(this.output);
  output.writeMessageBegin('get_counter', Thrift.MessageType.CALL, this.seqid)
  var args = new Cassandra_get_counter_args()
  args.key = key
  args.path = path
  args.consistency_level = consistency_level
  args.write(output)
...
CassandraClient.prototype.recv_get_counter = function(input,mtype,rseqid){
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException()
  ...
  var result = new Cassandra_get_counter_result()
  result.read(input)
  input.readMessageEnd()
  ...
  return callback("get_counter failed: unknown result");
}
CassandraClient.prototype.get_counter_slice = function(key,column_parent,predicate,consistency_level,callback){
  this.seqid += 1;
  this._reqs[this.seqid] = callback;
    this.send_get_counter_slice(key, column_parent, predicate, consistency_level)
}

CassandraClient.prototype.send_get_counter_slice = function(key,column_parent,predicate,consistency_level){
  var output = new this.pClass(this.output);
  output.writeMessageBegin('get_counter_slice', Thrift.MessageType.CALL, this.seqid)
  var args = new Cassandra_get_counter_slice_args()
  args.key = key
  args.column_parent = column_parent
  args.predicate = predicate
  args.consistency_level = consistency_level
...
CassandraClient.prototype.recv_get_counter_slice = function(input,mtype,rseqid){
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException()
  ...
  var result = new Cassandra_get_counter_slice_result()
  result.read(input)
  input.readMessageEnd()
  ...
  return callback("get_counter_slice failed: unknown result");
}
CassandraClient.prototype.multiget_counter_slice = function(keys,column_parent,predicate,consistency_level,callback){
  this.seqid += 1;
  this._reqs[this.seqid] = callback;
    this.send_multiget_counter_slice(keys, column_parent, predicate, consistency_level)
}

CassandraClient.prototype.send_multiget_counter_slice = function(keys,column_parent,predicate,consistency_level){
  var output = new this.pClass(this.output);
  output.writeMessageBegin('multiget_counter_slice', Thrift.MessageType.CALL, this.seqid)
  var args = new Cassandra_multiget_counter_slice_args()
  args.keys = keys
  args.column_parent = column_parent
  args.predicate = predicate
  args.consistency_level = consistency_level
...
CassandraClient.prototype.recv_multiget_counter_slice = function(input,mtype,rseqid){
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException()
  ...
  var result = new Cassandra_multiget_counter_slice_result()
  result.read(input)
  input.readMessageEnd()
  ...
  return callback("multiget_counter_slice failed: unknown result");
}
...
CassandraProcessor.prototype.process_get_counter = function(seqid, input, output) {
  var args = new Cassandra_get_counter_args()
  args.read(input)
  input.readMessageEnd()
  var result = new Cassandra_get_counter_result()
  this._handler.get_counter(args.key, args.path, args.consistency_level, function(success) {
    result.success = success
    output.writeMessageBegin("get_counter", Thrift.MessageType.REPLY, seqid)
    result.write(output)
    output.writeMessageEnd()
    output.flush()
  })
...
CassandraProcessor.prototype.process_get_counter_slice = function(seqid, input, output) {
  var args = new Cassandra_get_counter_slice_args()
  args.read(input)
  input.readMessageEnd()
  var result = new Cassandra_get_counter_slice_result()
  this._handler.get_counter_slice(args.key, args.column_parent, args.predicate, args.consistency_level, function(success) {
    result.success = success
    output.writeMessageBegin("get_counter_slice", Thrift.MessageType.REPLY, seqid)
    result.write(output)
    output.writeMessageEnd()
    output.flush()
  })
...
CassandraProcessor.prototype.process_multiget_counter_slice = function(seqid, input, output) {
  var args = new Cassandra_multiget_counter_slice_args()
  args.read(input)
  input.readMessageEnd()
  var result = new Cassandra_multiget_counter_slice_result()
  this._handler.multiget_counter_slice(args.keys, args.column_parent, args.predicate, args.consistency_level, function(success) {
    result.success = success
    output.writeMessageBegin("multiget_counter_slice", Thrift.MessageType.REPLY, seqid)
    result.write(output)
    output.writeMessageEnd()
    output.flush()
  })
