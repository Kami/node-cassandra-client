...
Counter.prototype.read = function(input){ 
  ...
  while (1) 
  {
    ...
    switch(fid)
    {
      ...
      break
      case 2:      if (ftype == Thrift.Type.STRUCT) {
        this.super_column = new ttypes.CounterSuperColumn()
        this.super_column.read(input)
      } else {
        input.skip(ftype)
      }
...
Mutation.prototype.read = function(input){ 
  ...
  while (1) 
  {
    ...
    switch(fid)
    {
      ...
      break
      case 3:      if (ftype == Thrift.Type.STRUCT) {
        this.counter = new ttypes.Counter()
        this.counter.read(input)
      } else {
        input.skip(ftype)
      }
      break
...
Mutation.prototype.write = function(output){ 
  ...
  if (null != this.counter) {
    output.writeFieldBegin('counter', Thrift.Type.STRUCT, 3)
    this.counter.write(output)
    output.writeFieldEnd()
  }
  output.writeFieldStop()
  output.writeStructEnd()
